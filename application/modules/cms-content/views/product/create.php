            ...
            <div class="portlet-body form">
                ...
                <div class="form-body">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input name="name" placeholder="Nhập tên sản phẩm" type="text" class="form-control input_name" id="input_name">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <textarea class="form-control" placeholder="Nhập tóm tắt bài viết" name="description" rows="3"></textarea>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input name="summary" placeholder="Nhập miêu tả bài viêt" type="text" class="form-control">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-8">
                            <input name="link" placeholder="Nhập linh sản phẩm" type="text" class="form-control">
