                    ...
                    <div class="portlet-body">
                        <div class="table-toolbar">
                            <form action="<?php echo base_url($this->modules_link); ?>" method="GET" class="form-horizontal form-bordered" id="filter_box">
                                <div class="row">
                                    <!-- Filter Name -->
                                    <div class="col-md-3">
                                        <input type="text" name="name" value="<?php if (isset($name)) {echo $is_name;} ?>" placeholder="Nhập tên option" class="form-control">
                                        <div class="help-block">Tên option</div>
                                    </div>
                                    ...
                                    <!-- Filter MAX Results -->
                                    <div class="col-md-2 max-results">
                        ...
                        <table class="table table-striped table-bordered table-hover" id="table_desc">
                            ...
                            <?php foreach($data['item_lists'] as $item) {
                                ...
                                <div class="modal fade" id="<?php echo 'td_confirm_delete_' . $item->option_id; ?>" tabindex="-1" role="basic" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Bạn có chắc chắn muốn xóa: <?php echo $item->option_name; ?> ?
                                            </div>
                                            <div class="modal-footer">
                                                <?php echo form_open($this->modules_link.'/delete'); ?>
                                                <input type="hidden" name="delete_id" value="<?php echo $item->option_id; ?>">
                                                <button type="submit" name="Delete_the_Item" value="<?php echo config_item('confirm_key_delete'); ?>" id="Delete_the_Item_btn_<?php echo $item->option_id; ?>" class="btn sbold red"><i class="fa fa-trash-o"></i> Xóa</button>
                                                <?php echo form_close(); ?>
                                ...
                                <!-- BEGIN MODAL -->
                                <div class="modal fade" id="<?php echo 'td' . $item->option_id; ?>" tabindex="-1" role="basic" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td>
                                        <a class="btn blue btn-outline" data-toggle="modal" href="<?php echo '#td' . $item->option_id; ?>">Chi tiết</a>
                                    </td>
                                    <td><?php foreach (config_item('option_type') as $key => $value) {
                                        if($item->option_type == $key)
                                            echo $value;
                                        }
                                        ?></td>
                                    <td>
                                        <a href="<?php echo site_url($this->modules_link.'/edit/'.$item->option_id); ?>" class="btn btn-circle btn-sm green"><i class="fa fa-edit" ></i> Sửa</a></td>
                                    <td>
                                        <a class="btn btn-sm btn-circle sbold dark" data-toggle="modal" href="<?php echo '#td_confirm_delete_' . $item->option_id; ?>"><i class="fa fa-trash-o"></i> Xóa</a>
                                    </td>
                                </tr>
                            <?php } ?>
