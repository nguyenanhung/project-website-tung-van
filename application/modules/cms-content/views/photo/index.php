                    ...
                    <div class="portlet-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <select name="type" class="bs-select form-control" data-style="green-meadow">
                                            ...
                                            <?php foreach (config_item('photo_type') as $key => $value) {?>
                        ...
                        <table class="table table-striped table-bordered table-hover" id="table_desc">
                            ...
                            <?php foreach($data['item_lists'] as $item) {
                                ...
                                <div class="modal fade" id="<?php echo 'td_confirm_delete_' . encodeId_Url_byHungDEV($item->photos_id); ?>" tabindex="-1" role="basic" aria-hidden="true" style="display: none;">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                Bạn có chắc chắn muốn xóa: <?php echo $item->photos_name; ?> ?
                                            </div>
                                            <div class="modal-footer">
                                                <?php echo form_open($this->modules_link.'/delete'); ?>
                                                <input type="hidden" name="delete_id" value="<?php echo encodeId_Url_byHungDEV($item->photos_id); ?>">
                                                <button type="submit" name="Delete_the_Item" value="<?php echo config_item('confirm_key_delete'); ?>" id="Delete_the_Item_btn_<?php echo encodeId_Url_byHungDEV($item->photos_id); ?>" class="btn sbold red"><i class="fa fa-trash-o"></i> Delete</button>
                                                <?php echo form_close(); ?>
                                ...
                                <tr class="odd gradeX">
                                    <td><?php echo $item->photos_id; ?></td>
                                    <td><?php echo $item->photos_name; ?></td>
                                    <td class="text-center"><img src="<?php echo $item->photo; ?>" width="260px" /></td>
                                    <td><?php foreach (config_item('photo_type') as $key => $type) {
                                        if($item->photos_type == $key) echo $type;} ?>
                                    </td>
                                    <td>
                                        <a href="<?php echo site_url($this->modules_link.'/edit/'.encodeId_Url_byHungDEV($item->photos_id)); ?>" class="btn btn-circle btn-sm green"><i class="fa fa-edit"></i> Edit</a></td>
                                    <td>
                                        <a class="btn btn-sm btn-circle sbold dark" data-toggle="modal" href="<?php echo '#td_confirm_delete_' . encodeId_Url_byHungDEV($item->photos_id); ?>"><i class="fa fa-trash-o"></i> Delete</a>
                                    </td>
                                </tr>
                            <?php } ?>
                            </tbody>
