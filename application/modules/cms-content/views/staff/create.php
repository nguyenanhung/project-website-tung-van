                    ...
                    <div class="portlet-body form">
                        ...
                        <div class="form-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input name="name" placeholder="Nhập họ tên" type="text" class="form-control" required="required">
                                    <p class="help-block">VD: Nguyễn An Hưng</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input name="position" placeholder="Nhập vị trí" type="text" class="form-control" required="required">
                                    <p class="help-block">VD: CEO</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input name="link_fb" placeholder="Nhập link FB" type="text" class="form-control">
                                    <p class="help-block">Link FB</p>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input name="link_twitter" placeholder="Nhập link Twitter" type="text" class="form-control">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-8">
                                    <input name="link_fb" placeholder="Nhập link Google" type="text" class="form-control">
