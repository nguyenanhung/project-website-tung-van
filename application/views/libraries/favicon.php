<!-- Generate icons for Web, Android, Microsoft, and iOS (iPhone and iPad) Apps - Add by HungNA -->
...
<meta name="msapplication-TileImage" content="<?php echo assets_url('favicon/ms-icon-144x144.png'); ?>">
