                ...
                <div class="col-md-12">
                    ...
                    <div class="top-social-icon icons-hover-black">
                        <div class="icons-hover-black">
                            <a href="javascript:avoid(0);"> <i class="fa fa-facebook"></i> </a><a href="javascript:avoid(0);"> <i class="fa fa-twitter"></i> </a><a href="javascript:avoid(0);"> <i class="fa fa-youtube"></i>
                            </a><a href="javascript:avoid(0);"> <i class="fa fa-dribbble"></i> </a><a href="javascript:avoid(0);"> <i class="fa fa-linkedin"></i> </a>
                        </div>
                    </div>
                </div>
            </div>
...
<div class="col-md-9 nav-bg">
    ...
    <div class="nav-wrap">
        <div class="container">
            ...
            <div class="col-md-3">
                <div class="logo">
                    <a href="<?php echo base_url(); ?>"><img src="<?= assets_url('images/logo-tungvan.png'); ?>" alt="TungVan"></a>
                </div>
                <!-- Phone Menu button -->
