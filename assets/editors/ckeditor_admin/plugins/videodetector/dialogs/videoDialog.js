...
CKEDITOR.dialog.add( 'videoDialog', function( editor ) {
    return {
        title: 'Chèn video từ Youtube, Vimeo, Dailymotion URL hoặc mã nhúng',
        minWidth: 400,
        minHeight: 100,
        contents: [
            {
                ...
                elements: [
                    {
                        type: 'text',
                        id: 'url_video',
                        label: 'Youtube, Vimeo, Dailymotion URL hoặc mã nhúng',
        ...
        onOk: function() {
            ...
            p.setAttribute("class", "content_video_player");

            var iframe = new CKEDITOR.dom.element( 'iframe' );
            iframe.setAttribute("src", url);
            iframe.setAttribute("frameborder", "0");
            iframe.setAttribute("class", "iframe_video");
